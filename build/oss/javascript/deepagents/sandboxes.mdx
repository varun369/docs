...
If you provision sandboxes in [middleware](/oss/javascript/deepagents/middleware), there is no `on_error` hook for cleanup when exceptions occur. As a workaround:
